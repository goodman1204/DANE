...
if __name__=='__main__':
    ...
    dataset_config = {'feature_file': './Database/args.dataset/features.txt',
                      'graph_file': './Database/args.dataset/edges.txt',
                      'walks_file': './Database/args.dataset/walks.txt',
                      'label_file': './Database/args.dataset/group.txt'}
    ...
    pretrain_config = {
        ...
        'pretrain_params_path': './Log/args.dataset/pretrain_params.pkl'}
    ...
    trainer_config = {
        ...
        'alpha': 0.0005,
        'gamma': 0.001,
        'model_path': './Log/args.dataset/args.dataset_model.pkl',
    }
